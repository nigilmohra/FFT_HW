...
This repository contains a 16-bit fixed-point Verilog implementation of a combined 8-point forward and inverse Fast Fourier Transform (FFT/IFFT). The hardware uses the same module to perform both FFT and IFFT based on the relationship given in the Equation. The design has a tolerance of up to 5 LSB. The maximum error observed was approximately 2.5 to 2.6 LSB across 100 test cases for both FFT and IFFT. 
