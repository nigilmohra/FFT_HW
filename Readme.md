...
This repository contains a 16-bit fixed-point Verilog implementation of a combined 8-point forward and inverse Fast Fourier Transform (FFT/IFFT), using the **Q3.12** format (3 integer and 12 fractional bits). The hardware uses the same module to perform both FFT and IFFT, based on the relationship given in Equation 1. The initial golden reference was generated using MATLAB and was later replaced with a C++ implementation.
